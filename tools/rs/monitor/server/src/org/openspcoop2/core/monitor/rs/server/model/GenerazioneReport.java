...
@XmlEnumValue("numeroTransazioni") NUMEROTRANSAZIONI(String.valueOf("numeroTransazioni")), @XmlEnumValue("occupazioneBanda") OCCUPAZIONEBANDA(String.valueOf("occupazioneBanda")), @XmlEnumValue("TempoMedioRisposta") TEMPOMEDIORISPOSTA(String.valueOf("TempoMedioRisposta"));
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    tipoReport: ").append(toIndentedString(tipoReport)).append("\n");
    ...
    sb.append("    tipoGrafico: ").append(toIndentedString(tipoGrafico)).append("\n");
    sb.append("    unitaTempo: ").append(toIndentedString(unitaTempo)).append("\n");
    sb.append("    visualizza: ").append(toIndentedString(visualizza)).append("\n");
    sb.append("}");
    return sb.toString();
  }
